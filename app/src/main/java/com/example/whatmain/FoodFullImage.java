        ...
        heartsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(checkHeart){
                    ...
                    // 좋아요 넣어주기
                    checkHeart = true;
                    System.out.println("온클릭~~~~~~~~~ id :"+get_foodDto.getId());
...
//                       //key값에 따라 value값을 쪼개 받아옵니다.
                        ...
                        if(loginCode==1){
                            Toast.makeText(getApplicationContext(), get_foodDto.getMainTitle()+" 좋아요 !", Toast.LENGTH_SHORT).show();
                        }else {
...
//                       //key값에 따라 value값을 쪼개 받아옵니다.
                        ...
                        System.out.println("loginCode : "+loginCode);
                        if(loginCode==1){
                            Toast.makeText(getApplicationContext(), get_foodDto.getMainTitle()+" 좋아요 취소!", Toast.LENGTH_SHORT).show();
                        }else {
